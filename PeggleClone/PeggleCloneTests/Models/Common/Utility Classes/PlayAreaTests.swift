...
class PlayAreaTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        playArea = PlayArea(width: 10, height: 10, cannonZoneHeight: 1, bucketZoneHeight: 1)
    }
    ...
    func testEqual_differentPlayAreaSize_returnsFalse() {
        let anyDifferentPlayArea1 = PlayArea(width: 10, height: 9, cannonZoneHeight: 1, bucketZoneHeight: 1)

        let anyDifferentPlayArea2 = PlayArea(width: 9, height: 10, cannonZoneHeight: 1, bucketZoneHeight: 1)
    ...
    func testEqual_samePlayAreaSize_returnsTrue() {
        let anySamePlayArea = PlayArea(width: 10, height: 10, cannonZoneHeight: 1, bucketZoneHeight: 1)
